...
var IWPM = {
    ...
    selectors: {
        dataAttrs: '#iwpm_data_args',
        container: '.iwpm-container',
        treeContainer: '.iwpm-terms-tree',
        treeContainerInner: '.iwpm-terms-tree__inner',
...
function initMenuAccordion() {
    var $ = jQuery;
    var selectors = IWPM.selectors;
    var classes = IWPM.classes;
        ...
        */
        ...
        function processClick() {
            ...
            if (isExpanded($item)) { // Only if expanded
                collapse($item);
                if (data[IWPM.dataAttrs.collapseChildren]) {
                    collapseChildren($item);
                }
            } else {
                expand($item);
                if (data[IWPM.dataAttrs.collapseOther]) {
                    collapseOther($item);
                }
            }
        ...
        function processDisableParentLinks() {
            if (data.hasOwnProperty(IWPM.dataAttrs.disableParentLinks)) {
        ...
        function processInitialExpansion() {
            ...
            if ($elements.length) {
                var screenWidth = parseInt(data[IWPM.dataAttrs.initialExpansionDisableScreenWidth]);
        ...
        function expand($element, duration) {
            if (hasChildren($element)) {
                ...
                duration = duration === undefined ? data[IWPM.dataAttrs.expandAnimationDuration] : duration;
        ...
        function collapse($element, duration) {
            if (hasChildren($element)) {
                duration = duration === undefined ? data[IWPM.dataAttrs.collapseAnimationDuration] : duration;
